...
pluralCaseList.push( {plural: "memberManagements/customers", pascal: "MemberManagementCustomer"} )

pluralCaseList.push( {plural: "productManagements/products", pascal: "ProductManagementProduct"} )

pluralCaseList.push( {plural: "orderProcessings/orders", pascal: "OrderProcessingOrder"} )

pluralCaseList.push( {plural: "supplierManagements/suppliers", pascal: "SupplierManagementSupplier"} )
