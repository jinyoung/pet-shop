            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="customers"
                        to="/memberManagements/customers"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="suppliers"
                        to="/supplierManagements/suppliers"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '고객', 
                description: '애완동물을 소유한 사람으로, 애완동물 제품을 구매할 목적으로 쇼핑몰에 접근하는 역할입니다.', 
                key: 'customers', 
                route: '/memberManagements/customers',
                ImageUrl: '',
            },
            { 
                title: '상품', 
                description: '애완동물에 필요한 제품 정보를 담당하는 독립된 영역입니다.', 
                key: 'products', 
            ...
            { 
                title: '주문', 
                description: '주문 접수, 배송 처리, 결제 등의 기능을 담당하는 독립된 영역입니다.', 
                key: 'orders', 
                route: '/orderProcessings/orders',
                ImageUrl: '',
            },
            { 
                title: '공급업체', 
                description: '동물 제품 공급업체를 관리하는 독립된 영역입니다.', 
                key: 'suppliers', 
                route: '/supplierManagements/suppliers',
                ImageUrl: '',
            },
            { 
                title: '택배', 
                description: '쇼핑몰에서 고객이 주문한 제품을 배송하는 역할을 담당합니다.', 
                key: 'deliveries', 
