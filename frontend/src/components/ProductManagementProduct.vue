<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            <String v-if="editMode" label="상품 ID" v-model="value.productId" :editMode="editMode" :inputUI="''"/>
            <String label="상품명" v-model="value.name" :editMode="editMode" :inputUI="''"/>
            <Money offline label="가격" v-model="value.price" :editMode="editMode" @change="change"/>
            <Supplier offline label="Supplier" v-model="value.supplier" :editMode="editMode" @change="change"/>
        </v-card-text>
